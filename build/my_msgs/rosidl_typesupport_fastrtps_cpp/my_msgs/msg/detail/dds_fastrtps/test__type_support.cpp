...
#include "my_msgs/msg/detail/test__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const my_msgs::msg::Test & ros_message,
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_msgs::msg::Test;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_msgs::msg::Test *>(
    untyped_ros_message);
...
{
  return &my_msgs::msg::typesupport_fastrtps_cpp::_Test__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_msgs, msg, Test)() {
  return &my_msgs::msg::typesupport_fastrtps_cpp::_Test__handle;
}
