...
bool my_msgs__msg__test__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_msgs.msg._test.Test", full_classname_dest, 22) == 0);
  }
  my_msgs__msg__Test * ros_message = _ros_message;
  {  // log
  ...
  {  // pose
    ...
    ros_message->pose = PyLong_AsLongLong(field);
    Py_DECREF(field);
  }
...
PyObject * my_msgs__msg__test__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_msgs.msg._test");
  ...
  {  // pose
    PyObject * field = NULL;
    field = PyLong_FromLongLong(ros_message->pose);
    {
