...
#include "my_msgs/srv/detail/test__rosidl_typesupport_fastrtps_c.h"
...
using _Test_Request__ros_msg_type = my_msgs__srv__Test_Request;
...
size_t get_serialized_size_my_msgs__srv__Test_Request(
  const void * untyped_ros_message,
...
static uint32_t _Test_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_msgs__srv__Test_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_msgs
size_t max_serialized_size_my_msgs__srv__Test_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_msgs__srv__Test_Request;
    is_plain =
      (
      offsetof(DataType, b) +
      last_member_size
...
static size_t _Test_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_msgs__srv__Test_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_msgs, srv, Test_Request)() {
...
using _Test_Response__ros_msg_type = my_msgs__srv__Test_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_msgs
size_t get_serialized_size_my_msgs__srv__Test_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Test_Response__ros_msg_type * ros_message = static_cast<const _Test_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_my_msgs__srv__Test_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_msgs
size_t max_serialized_size_my_msgs__srv__Test_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = my_msgs__srv__Test_Response;
    is_plain =
      (
...
static size_t _Test_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_msgs__srv__Test_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_msgs, srv, Test_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_msgs, srv, Test)() {
  return &Test__handle;
}
